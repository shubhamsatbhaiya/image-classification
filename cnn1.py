...
# In[60]:
#Helper-function to  plot the  examples of images from test set which have been correctly classified.
def plot_correct(cls_pred, correct):
   
    images = images_test[correct]
...
def print_test_accuracy(show_example_errors=False,
                        show_confusion_matrix=False,show_correct=False):
    ...
    if show_correct:
        ...
        plot_correct(cls_pred=cls_pred, correct=correct)
...
print_test_accuracy(show_example_errors=True,
                    show_confusion_matrix=True,show_correct=True)
